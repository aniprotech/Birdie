...
import { filterItems, noteOptions, renderActiveNotification } from "../../../../data/teams/carerFeed";
import useScrollToTop from "../../../../hooks/useScrollToTop";
import { useClickOutside } from "../../../../hooks/use-click-outside";
import { Filter } from "lucide-react";
import { Outlet, useNavigate, useParams } from "react-router-dom";

const CarerFeedIndex = () => {
    // --- state ---
    ...
    const NoteComponent = selectedNoteType?.component || FeedDetails;
        ...
        <div className="flex h-screen flex-col overflow-hidden bg-white lg:flex-row">
                                    ...
                                    {noteOptions.slice(0, 2).map((opt, i) => (
                                        <div
                                            ...
                                            onClick={() => {
                                                ...
                                                setShowDropdownMobile(false);
                                                setMobileSidebarOpen(false);
                                                navigate(`/admin/teams/${id}/carer-feed/${opt.to}`);
                                            }}
            ...
            <div className="flex flex-1 flex-col overflow-hidden lg:flex-row">
                ...
                >
                    ...
                    {renderActiveNotification(activeNotification)}
                    </div>
                </div>
