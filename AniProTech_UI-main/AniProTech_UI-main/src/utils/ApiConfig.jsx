...
const APIConfig = {
    ...
    CLIENT_CARE_PLAN: {
        ...
        ADDITIONAL_ASSESSMENT: {
            ...
            COVID_19_ASSESSMENT: {
                CREATE_COVID_19_ASSESSMENT: (id) => `${BASE_URL}/client-care-plan/covid-19/assessment/${id}`,
                GET_COVID_19_ASSESSMENT_BY_ID: (id) => `${BASE_URL}/client-care-plan/covid-19/assessment/${id}`,
                GET_COVID_19_ASSESSMENT_BY_CLIENT_ID: (id) => `${BASE_URL}/client-care-plan/covid-19/${id}`,
                UPDATE_COVID_19_ASSESSMENT: (id) => `${BASE_URL}/client-care-plan/covid-19/assessment/${id}`,
                DELETE_COVID_19_ASSESSMENT: (id) => `${BASE_URL}/client-care-plan/covid-19/assessment/${id}`,

                CREATE_COVID_19_RISK: (id) => `${BASE_URL}/client-care-plan/covid-19/risk/${id}`,
                GET_COVID_19_RISK_BY_ID: (id) => `${BASE_URL}/client-care-plan/covid-19/risk/${id}`,
                UPDATE_COVID_19_RISK: (id) => `${BASE_URL}/client-care-plan/covid-19/risk/${id}`,
                DELETE_COVID_19_RISK: (id) => `${BASE_URL}/client-care-plan/covid-19/risk/${id}`,
            },
            ...
            ENVIRONMENTAL_AND_FIRE_ASSESSMENT: {
                CREATE_ENVIRONMENTAL_AND_FIRE_ASSESSMENT: (id) => `${BASE_URL}/client-care-plan/environmental-and-fire/assessment/${id}`,
                GET_ENVIRONMENTAL_AND_FIRE_ASSESSMENT_BY_ID: (id) => `${BASE_URL}/client-care-plan/environmental-and-fire/assessment/${id}`,
                GET_ENVIRONMENTAL_AND_FIRE_ASSESSMENT_BY_CLIENT_ID: (id) => `${BASE_URL}/client-care-plan/environmental-and-fire/${id}`,
                UPDATE_ENVIRONMENTAL_AND_FIRE_ASSESSMENT: (id) => `${BASE_URL}/client-care-plan/environmental-and-fire/assessment/${id}`,
                DELETE_ENVIRONMENTAL_AND_FIRE_ASSESSMENT: (id) => `${BASE_URL}/client-care-plan/environmental-and-fire/assessment/${id}`,

                CREATE_ENVIRONMENTAL_AND_FIRE_RISK: (id) => `${BASE_URL}/client-care-plan/environmental-and-fire/risk/${id}`,
                GET_ENVIRONMENTAL_AND_FIRE_RISK_BY_ID: (id) => `${BASE_URL}/client-care-plan/environmental-and-fire/risk/${id}`,
                UPDATE_ENVIRONMENTAL_AND_FIRE_RISK: (id) => `${BASE_URL}/client-care-plan/environmental-and-fire/risk/${id}`,
                DELETE_ENVIRONMENTAL_AND_FIRE_RISK: (id) => `${BASE_URL}/client-care-plan/environmental-and-fire/risk/${id}`,
            },
