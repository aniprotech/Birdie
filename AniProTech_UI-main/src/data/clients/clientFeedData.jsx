...
import ClientActionsNotifications from "../../pages/Clients/ViewClients/CarerFeed/FeedNotifications/ActionsNotifications";
import ClientAlertNotifications from "../../pages/Clients/ViewClients/CarerFeed/FeedNotifications/AlertNotifications";
import ClientAllFeedNotification from "../../pages/Clients/ViewClients/CarerFeed/FeedNotifications/AllFeedNotification";
import ClientNotesNotifications from "../../pages/Clients/ViewClients/CarerFeed/FeedNotifications/NotesNotifications";
import ClientVisitNotifications from "../../pages/Clients/ViewClients/CarerFeed/FeedNotifications/VisitNotifications";

export const renderActiveNotification = (activeNotification, props) => {
    switch (activeNotification) {
        case "Alerts":
            return <ClientAlertNotifications {...props} />;
        case "Visits":
            return <ClientVisitNotifications {...props} />;
        case "Notes":
            return <ClientNotesNotifications {...props} />;
        case "Actions":
            return <ClientActionsNotifications {...props} />;
        case "All":
        default:
            return <ClientAllFeedNotification {...props} />;
    }
};
