...
import { getAdditionalAssessmentDescription, getAdditionalAssessmentQuestions } from "../../../../../constants/clientCarePlan";
import { capitalizeFirstLetter } from "../../../../../utils/common";

const AdditionalAssessmentPage = () => {
    ...
    const urlAssessmentName = location?.state?.assessmentName;
    const clientName = clientsPersonalDetailData?.firstName || "the client";

    useEffect(() => {
        if (urlAssessmentName) {
            setAssessmentName(urlAssessmentName);
        }
    }, [urlAssessmentName]);
    ...
    const description = getAdditionalAssessmentDescription(assessmentType);

    const questions = getAdditionalAssessmentQuestions(assessmentType);
            ...
            <div className="mx-auto flex gap-10 px-6 pb-40 pt-7 md:px-20 xl:px-60">
                <div className="flex-1">
                    <AssessmentForm
                        ...
                        assessmentPageType="Additional_Assessment"
                    />
                </div>
...
export default AdditionalAssessmentPage;
