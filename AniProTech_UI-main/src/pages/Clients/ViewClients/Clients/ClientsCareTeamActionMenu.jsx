...
const ClientsCareTeamActionMenu = ({ rowId, rowData, clientId, onSuccess }) => {
    ...
    const updateCareTeam = async () => {
        ...
        try {
            ...
            await _put(APIConfig.CLIENT_CARE_TEAM.BULK_UPDATE(clientId), payload);
...
ClientsCareTeamActionMenu.propTypes = {
...
export default ClientsCareTeamActionMenu;
