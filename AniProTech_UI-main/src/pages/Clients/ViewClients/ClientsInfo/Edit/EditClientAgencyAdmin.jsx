...
import { agencyAdminConfig } from "../../../../../data/clients/clinicalDetailsConfig";

const EditClientAgencyAdmin = ({ data, setData, mode, setMode }) => {
    return (
...
export default EditClientAgencyAdmin